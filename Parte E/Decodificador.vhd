...
ARCHITECTURE SYN OF Decodificador IS


	COMPONENT Decodificador_dec8b10b
	PORT (
		clk	: IN STD_LOGIC;
		reset_n	: IN STD_LOGIC;
		idle_del	: IN STD_LOGIC;
...
BEGIN
	...
	Decodificador_dec8b10b_inst : Decodificador_dec8b10b
	PORT MAP (
		clk  =>  clk,
		reset_n  =>  reset_n,
		idle_del  =>  idle_del,
...
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.MVCModel"  active_core="Decodificador_dec8b10b" >
...
-- Retrieval info:      <PRIVATE name = "p_iptb_top" value="Decodificador"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "filename" value="Decodificador.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "greybox">
-- Retrieval info:      <PRIVATE name = "filename" value="Decodificador_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- =========================================================
-- RELATED_FILES: Decodificador_dec8b10b.v, Decodificador.vhd;
-- IPFS_FILES: Decodificador.vho;
-- =========================================================
